...
# ПланФикс API task.getFilterList
...
# ПланФикс API task.getPossibleStatusToChange
...
# ПланФикс API task.changeStatus
...
# ПланФикс API task.changeWorkers
...
# ПланФикс API task.changeExpectDate
...
# ПланФикс API taskStatus.getSetList
...
# ПланФикс API: Системные статусы задач
...
# ПланФикс API: Типы сортировок задач

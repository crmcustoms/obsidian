...
# ПланФикс API user.changeStatus
...
# ПланФикс API user.actionsAdded
...
# ПланФикс API user.updateGroupMembership
...
# ПланФикс API userGroup.getList
...
# ПланФикс API userGroup.getHeads
...
# ПланФикс API: Роли пользователей
...
# ПланФикс API: Статусы пользователей
...
# ПланФикс API: Типы сортировок пользователей
...
# ПланФикс API: Фильтры сотрудников
